...
[the issues labeled `good first issue`](https://github.com/snowplow/snowplow-php-tracker/labels/good%20first%20issue).
...
You can find more information on the topic in [the dedicated docs page](https://docs.snowplow.io/docs/contributing/contributor-license-agreement/).
